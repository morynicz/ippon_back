...
class CupFightSiblingTests(TestCupFights):
    ...
    def test_cup_fight_when_winner_is_set_and_sibling_has_winner_already_set_creates_team_fight_in_parent(
        self,
    ):
    ...
    def test_when_aka_fight_winner_is_set_and_shiro_sibling_doesnt_have_winner_yet_doesnt_change_parent(
        self,
    ):
        self.cf_aka.team_fight.winner = 1
        self.cf_aka.team_fight.save()
    ...
    def test_when_shiro_fight_winner_is_set_and_aka_sibling_doesnt_have_winner_yet_doesnt_change_parent(
        self,
    ):
    ...
    def test_when_shiro_fight_winner_is_changed_and_parent_was_laready_created_but_still_in_prep_change_parent(
        self,
    ):
        self.cf_aka.team_fight.winner = 1
        self.cf_aka.team_fight.save()
...
class CupPhaseTests(TestCase):
    def setUp(self) -> None:
        ...
        self.p5 = plm.Player.objects.create(
            name="pn5",
            surname="ps5",
            rank=7,
            birthday=datetime.date(year=2001, month=1, day=1),
        ...
        self.p6 = plm.Player.objects.create(
            name="pn6",
            surname="ps6",
            rank=7,
            birthday=datetime.date(year=2001, month=1, day=1),
        ...
        self.p7 = plm.Player.objects.create(
            name="pn7",
            surname="ps6",
            rank=7,
            birthday=datetime.date(year=2001, month=1, day=1),
        ...
        self.p8 = plm.Player.objects.create(
            name="pn8",
            surname="ps6",
            rank=7,
            birthday=datetime.date(year=2001, month=1, day=1),
