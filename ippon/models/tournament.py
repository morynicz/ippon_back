...
class TournamentParticipation(models.Model):
    ...
    def check_is_rank_ok(self):
        return is_numeric_constraint_satisfied(
            self.player.rank,
            self.tournament.rank_constraint,
            self.tournament.rank_constraint_value,
        )

    def check_is_sex_ok(self):
        constraints = {0: True, 1: self.player.sex == 1, 2: self.player.sex == 0}
...
SEX_CONSTRAINT = [(0, "None"), (1, "WomenOnly"), (2, "MenOnly")]
