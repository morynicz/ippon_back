...
WINNER = [(0, "None"), (1, "Aka"), (2, "Shiro")]
STATUS = [(0, "Prepared"), (1, "Started"), (2, "Finished")]
...
class TeamFight(models.Model):
    ...
    def __str__(self):
        return "TeamFight {{id: {id}, aka_team: {aka}, shiro_team: {shiro}, winner: {win} }}".format(
            id=self.id, aka=self.aka_team, shiro=self.shiro_team, win=self.winner
        )
