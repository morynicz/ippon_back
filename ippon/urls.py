...
urlpatterns = [
    ...
    url(r'^authorization/clubs/(?P<pk>[0-9]+)/$', ippon.club.views.club_authorization,
        name='club-authorization'),
    url(r'^authorization/tournaments/staff/(?P<pk>[0-9]+)/$', ippon.tournament.views.tournament_staff_authorization,
        name='tournament-staff-authorization'),
    url(r'^authorization/tournaments/admins/(?P<pk>[0-9]+)/$', ippon.tournament.views.tournament_admin_authorization,
        name='tournament-admin-authorization'),
    url(r'^authorization/fights/(?P<pk>[0-9]+)/$', ippon.fight.views.fight_authorization,
        name='fight-authorization'),
    url(r'^authorization/team_fights/(?P<pk>[0-9]+)/$', ippon.team_fight.views.team_fight_authorization,
        name='team-fight-authorization'),
    url(r'^authorization/teams/(?P<pk>[0-9]+)/$', ippon.team.views.team_authorization,
        name='team-authorization'),
    url(r'^authorization/groups/(?P<pk>[0-9]+)/$', ippon.group.views.group_authorization,
        name='group-authorization'),
    url(r'^authorization/group_phases/(?P<pk>[0-9]+)/$', ippon.group_phase.views.group_phase_authorization,
    ...
    url(r'^authorization/players/(?P<pk>[0-9]+)/$', ippon.player.views.player_authorization,
