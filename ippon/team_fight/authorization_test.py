...
class TournamentTeamFightAuthorizationAuthenticatedTests(
    ...
    def test_tournament_team_fight_authorization_returns_negative_auth_if_not_authorized(
        ...
        response = self.client.get(
            reverse("team-fight-authorization", kwargs={"pk": tf.pk})
        )
    ...
    def test_tournament_team_fight_authorization_returns_positive_auth_if_authorized_staff(
        ...
        self.parametrized_team_fight_authorization_returns_positive_auth_if_authorized(
            False
        )
    ...
    def parametrized_team_fight_authorization_returns_positive_auth_if_authorized(
        self, is_admin
    ):
