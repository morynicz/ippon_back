...
class CupFightViewTest(APITestCase):
    def setUp(self):
        ...
        self.cf1_json = {
            "id": self.cf1.id,
            "team_fight": self.tf1.id,
            "cup_phase": self.phase.id,
            "previous_aka_fight": None,
            "previous_shiro_fight": None,
        }
        self.cf2_json = {
            "id": self.cf2.id,
            "team_fight": self.tf2.id,
            "cup_phase": self.phase.id,
            "previous_aka_fight": self.cf1.id,
            "previous_shiro_fight": None,
        }
        self.cf3_json = {
            "id": self.cf3.id,
            "team_fight": None,
            "cup_phase": self.phase.id,
            "previous_aka_fight": self.cf2.id,
            "previous_shiro_fight": None,
        }
        self.valid_payload = {
            "id": self.cf1.id,
