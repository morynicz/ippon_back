...
class TournamentGroupAuthorizationAuthenticatedTests(
    ...
    def test_tournament_group_authorization_returns_negative_auth_if_not_authorized(
        self,
    ):
    ...
    def test_tournament_group_authorization_returns_positive_auth_if_authorized_staff(
        self,
    ):
        self.parametrized_group_authorization_returns_positive_auth_if_authorized(False)

    def test_tournament_group_authorization_returns_positive_auth_if_authorized_admin(
        self,
    ):
        self.parametrized_group_authorization_returns_positive_auth_if_authorized(True)

    def parametrized_group_authorization_returns_positive_auth_if_authorized(
        self, is_admin
    ):
