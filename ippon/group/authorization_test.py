...
class TournamentGroupAuthorizationAuthenticatedTests(AuthorizationViewsAuthenticatedTests):
    def setUp(self):
...
class GroupViewsUnauthenticatedTests(AuthorizationViewsUnauthenticatedTests):
    def setUp(self):
