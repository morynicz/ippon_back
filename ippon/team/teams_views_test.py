...
class TeamViewSetAuthorizedTests(TeamsViewTest):
    ...
    def test_teams_get_non_members_returns_list_of_participants_not_assigned_to_a_team(
        self,
    ):
        p4 = plm.Player.objects.create(
            ...
            surname="ps4",
            rank=7,
            birthday=datetime.date(year=2004, month=4, day=4),
            sex=1,
            club_id=self.c,
        )
